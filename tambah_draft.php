            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  <style>
                    ...
                    <!--ASLIII-->
                  <h4>Informasi Draft Raperkada ASLI</h4>
                    ...
                    <div class="form-group">
                        <!--ASLII-->
                      <label class="col-lg-12">Surat Permohonan raperkada</label>
                      <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <label class="col-lg-12">Rancangan Perkada</label>
                        <div class="col-lg-12">
                            <input id="rancangan_perkada"
                                   type="file"
                                   onchange="checkSelectedFile(id)"
                                   name="rancangan_perkada" class="form-control text-field" >
                            <small class="lh-1" style="color: red"><i>.pdf .doc .docx (*wajib)</i></small>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-lg-12">Draft Raperkada</label>
                        <div class="col-lg-12">
                    ...
                    <div class="form-group" style="background-color: ">
                        ...
                        <button class="btn btn-success m-l-15" id="add-more" type="button"
                            ...
                            <i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Dokumenz
                        </button>
    ...
    <!-- /dashboard content -->
      <script type="text/javascript">
          $( document ).ready(function() {
              ...
              $('#naskah_akademik_dll').prop('required', true);
