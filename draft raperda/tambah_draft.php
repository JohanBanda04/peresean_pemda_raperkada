        ...
        <div class="panel panel-inverse">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" action="" data-parsley-validate="true" method="post" enctype="multipart/form-data">
                  ...
                  <h4>Informasi Draft Raperda ASLII</h4>
                    <!--SEBELAH KIRI-->
                    <div class="col-md-6">
                        <div class="form-group">


                            <label class="col-lg-11"> Judull <b id='wajib_isi'>*</b></label>
                            <div class="col-lg-12">
                                <input type="text" name="nama_draft"
                                       id="nama_draft" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <select readonly="readonly" class="form-control default-select2"
                                        name="jenis_dokumen" id="jenis_dokumen" selected="<?php echo $query->level; ?>" required>
                        ...
                        <div class="form-group">
                            <label class="col-lg-12">Surat Keputusan Tim Penyusun</label>
                            <div class="col-lg-12">
                                <input id="lamp_surat_keputusan_tim_penyusun"
                                       type="file"
                                       onchange="checkSelectedFile(id)"
                                       name="lamp_surat_keputusan_tim_penyusun" class="form-control">
                                <small class="lh-1" style="color: red"><i>.pdf .doc .docx (*wajib)</i></small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label class="col-lg-12">Rancangan Perda</label>
                            <div class="col-lg-12">
                                <input id="lamp_rancangan_perda"
                                       type="file"
                                       onchange="checkSelectedFile(id)"
                                       name="lamp_rancangan_perda" class="form-control">
                                <small class="lh-1" style="color: red"><i>.pdf .doc .docx (*wajib)</i></small>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-12">Surat Keputusan DPRD</label>
                            <div class="col-lg-12">
                                <input id="lamp_surat_keputusan_dprd"
                                       type="file"
                                       onchange="checkSelectedFile(id)"
                                       name="lamp_surat_keputusan_dprd" class="form-control">
                                <small class="lh-1" style="color: red"><i>.pdf .doc .docx (*wajib)</i></small>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-lg-12">Surat Keputusan Bersama</label>
                            <div class="col-lg-12">
                                <input id="lamp_surat_keputusan_bersama"
                                       type="file"
                                       onchange="checkSelectedFile(id)"
                                       name="lamp_surat_keputusan_bersama" class="form-control">
                                <small class="lh-1" style="color: red"><i>.pdf .doc .docx (*wajib)</i></small>
                            </div>
                        </div>
                        ...
                        <div class="text-right ">
                            <a href="<?php echo ($this->uri->segment(1)); ?>/<?php echo ($this->uri->segment(2)); ?>/<?= $this->uri->segment(3)?>"
                               class="btn btn-default" style="background-color: #d2a729">
                                << Kembali
                            </a>
                            ...
                            <input style="float:right;" type="submit"
                                   id="btnsimpan" name="btnsimpan" class="btn btn-primary" value="Simpan" />
                        </div>
                    </div>
